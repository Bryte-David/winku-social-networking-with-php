									<div class="editing-info">
										...
										<form method="POST">
											<div class="form-group half">	
											  <input type="text" name="name" id="input" value="<?php echo $name ?>" required="required"/>
											  <label class="control-label" for="input">Fullname Name</label><i class="mtrl-select"></i>
											</div>
											<div class="form-group half">	
											  <input type="text" name="uname" value="<?php echo $username ?>" required="required"/>
											...
											<div class="form-group">	
											  <input type="date" name="dob" value="<?php echo $dob ?>" required="required"/>
											  <label class="control-label" for="input">Date of Birth</label><i class="mtrl-select"></i>
											</div>
											<div class="form-radio">
											  <div class="radio">
												<label>
												  <input type="radio" value="Male" <?php if ($gender == "Male") {
												  	echo "Checked";
												  }else{echo "";} ?> name="gender"><i class="check-box"></i>Male
												</label>
											  </div>
											  <div class="radio">
												<label>
												  <input type="radio" value="Female" <?php if ($gender == "Female") {
												  	echo "Checked";
												  }else{echo "";} ?>  name="gender"><i class="check-box"></i>Female
												</label>
											  </div>
											</div>
											<div class="form-group">	
											...
											<div class="form-group">	
											  <textarea rows="4" name="about" id="textarea" required="required"><?php echo $about_me ?></textarea>
											  <label class="control-label" for="textarea">About Me</label><i class="mtrl-select"></i>
											</div>
											<div class="submit-btns">
												<!-- <button type="button" class="mtr-btn"><span>Cancel</span></button> -->
												<button type="submit" name="update" id="update-btn" class="mtr-btn"><span>Update</span></but;ton>
											</div>
										</form>
									</div>